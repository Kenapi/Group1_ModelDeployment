...
# Load the model
model = load_model('app.hdf5')  # Ensure the model file is named app.h5
...
def main():
    ...
    if page == "Home":
        ...
        It accepts an image as input and predicts whether the image belongs to one of the available 100 sports categories seen within the Home Page. 
        """)
